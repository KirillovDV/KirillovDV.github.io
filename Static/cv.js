const copy = {
  ru: {
    ...
    vkThree: "Разрабатываю API-автотесты на Java и автоматизировал до 40% критичных API-сценариев.",
    ...
    vkSix: "Веду QA-процесс: тестовая стратегия, risk-based testing, DoR/DoD, quality gates, release readiness, RCA и postmortem; работаю с Docker, Kubernetes, ELK, Grafana, PostgreSQL и API-контрактами.",
    ...
    skillsTitle: "Навыки", skillLeadTitle: "QA Lead и процессы", skillLeadText: "QA strategy · risk-based testing · DoR / DoD · quality gates · release readiness · RCA / postmortem · Agile / Scrum · QA-координация · менторство · технические интервью",
    skillTestingTitle: "Тестирование", skillTestingText: "Функциональное · регрессионное · интеграционное · API · контрактное · security · accessibility · нагрузочное · тест-дизайн · тестовые данные и окружения",
    skillAutomationTitle: "Автоматизация и CI/CD", skillAutomationText: "Java · Python · pytest · requests · n8n · GitLab CI/CD · Jenkins · Allure · Git · code review автотестов",
    skillPlatformTitle: "Данные и инфраструктура", skillPlatformText: "REST / SOAP · JSON / XML · Swagger / OpenAPI · Postman · PostgreSQL · SQL · Kafka · Docker · Kubernetes · ELK · Grafana · Linux · Nginx",
  ...
  en: {
    ...
    vkThree: "Build API automated tests in Java and automated up to 40% of critical API scenarios.",
    ...
    vkSix: "Lead the QA process: test strategy, risk-based testing, DoR/DoD, quality gates, release readiness, RCA, and postmortems; work with Docker, Kubernetes, ELK, Grafana, PostgreSQL, and API contracts.",
    ...
    skillsTitle: "Skills", skillLeadTitle: "QA leadership & process", skillLeadText: "QA strategy · risk-based testing · DoR / DoD · quality gates · release readiness · RCA / postmortems · Agile / Scrum · QA coordination · mentoring · technical interviews",
    skillTestingTitle: "Testing", skillTestingText: "Functional · regression · integration · API · contract · security · accessibility · performance · test design · test data and environments",
    skillAutomationTitle: "Automation & CI/CD", skillAutomationText: "Java · Python · pytest · requests · n8n · GitLab CI/CD · Jenkins · Allure · Git · automated-test code review",
    skillPlatformTitle: "Data & infrastructure", skillPlatformText: "REST / SOAP · JSON / XML · Swagger / OpenAPI · Postman · PostgreSQL · SQL · Kafka · Docker · Kubernetes · ELK · Grafana · Linux · Nginx",
